        ...
        <AbsoluteFill>
          <OffthreadVideo
            ...
            style={{
              ...
              //    換過兩次但沒重量過，因為量出來幾乎一樣：77012ed5…（0914）臉部中點 x≈998
              //    ＝0.520，跟 5bad6432… 的 995 差 3px，成品看不出來，所以 52.7% 續用。
              //    2026-09-15 換成 484b6346… 之後**還沒量**：第一支出來看講者有沒有偏一邊，
              //    偏了就拿 heygen.mp4 的來源幀重量、套上面那條算式改這個數字
              //    （橫式 DapanLandscapeComposition.tsx 的 56.3% 同一組前提，要一起重算）。
